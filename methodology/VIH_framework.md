...
A primary authoritative source confirms the specific figure or statement
That source can be linked directly — not paraphrased, not summarized, but linked
No interpretation is required to connect the source to the claim
...
TagWhat it means for a decisionWhat to do[V] VerifiedSafe to cite. The figure is confirmed by a primary source you can link.Use it[I] InferredUse with caution. The direction is right but the specific figure is not confirmed.Acknowledge the uncertainty or find the primary source yourself[H] HypothesisDo not cite. The claim is unverified and may be significantly wrong.Discard or research independently before using
...
Claim extracted and listed before any source was consulted
Primary source consulted: ONTSI — Informe Anual sobre el Sector TIC 2024
ONTSI figure for the same metric, same year, same population: 11.31%
Discrepancy: the AI reported a figure nearly double the primary source
Tag applied: [H]
